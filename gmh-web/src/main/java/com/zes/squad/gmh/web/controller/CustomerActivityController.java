...
public class CustomerActivityController {
    ...
    public JsonResult<PagedList<CustomerActivityVo>> doListPagedConsumeRecord(@RequestBody CustomerActivityQueryParams params) {
    ...
    public JsonResult<List<CustomerActivityVo>> doGetCardPay(@RequestBody PaymentParams params) {
        ...
        List<CustomerActivityUnion> unionList = customerActivityService.getAcitvityListByMobile(params.getPaymentWay(),
